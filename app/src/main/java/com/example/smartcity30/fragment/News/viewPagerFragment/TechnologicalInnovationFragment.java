...
public class TechnologicalInnovationFragment extends Fragment {
    ...
    public RecyclerView rv_technological_innovation_news;
    public String BASE_URL = "http://124.93.196.45:10001";
    public List<NewsDetailsResult.RowsBean> newsDetailsDataList = new ArrayList<>();

    public TechnologicalInnovationFragment(int newsTypeIndex) {
        this.newsTypeIndex = newsTypeIndex;
    }

    public static TechnologicalInnovationFragment newInstance(int newsTypeIndex) {
        return new TechnologicalInnovationFragment(newsTypeIndex);
    }

    private void initView() {
        rv_technological_innovation_news = view.findViewById(R.id.rv_technological_innovation_news);
        rv_technological_innovation_news.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
        rv_technological_innovation_news.setAdapter(new NewsFragmentNewsListAdapter(newsDetailsDataList, requireActivity()));
    }
