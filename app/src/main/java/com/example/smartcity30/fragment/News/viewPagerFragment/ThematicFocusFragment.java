...
public class ThematicFocusFragment extends Fragment {
    ...
    public RecyclerView rv_thematic_focus_news;
    public String BASE_URL = "http://124.93.196.45:10001";
    public List<NewsDetailsResult.RowsBean> newsDetailsDataList = new ArrayList<>();

    public ThematicFocusFragment(int newsTypeIndex) {
        this.newsTypeIndex = newsTypeIndex;
    }

    public static ThematicFocusFragment newInstance(int newsTypeIndex) {
        return new ThematicFocusFragment(newsTypeIndex);
    }
    ...
    private void initView() {
        rv_thematic_focus_news = view.findViewById(R.id.rv_thematic_focus_news);
        rv_thematic_focus_news.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
        rv_thematic_focus_news.setAdapter(new NewsFragmentNewsListAdapter(newsDetailsDataList, requireActivity()));
    }
